...
%{
Para dos m¨¢scaras dadas: source, dest siento source < dest pega la mascara
source dentro de la m¨¢scara dest utilizando un punto Pt (de la mascara dest) dado como
referencia.

La referencia de la mascara source ser¨¢ su centro de masas.
%}
